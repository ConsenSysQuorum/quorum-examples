...
PRIVATE_CONFIG=qdata/c4/tm.ipc nohup geth --datadir qdata/dd41 $ARGS --permissioned --raftport 50404 --rpcport 42003 --port 21003 --unlock 0 --password passwords.txt 2>>qdata/logs/41.log &
...
PRIVATE_CONFIG=qdata/c4/tm.ipc nohup geth --datadir qdata/dd42 $ARGS --raftport 50408 --rpcport 42007 --port 21007 --unlock 0 --password passwords.txt 2>>qdata/logs/42.log &
set +v
