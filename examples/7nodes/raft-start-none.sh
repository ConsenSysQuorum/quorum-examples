...
ARGS="--verbosity 3 --gcmode archive --networkid $NETWORK_ID --raft --rpc --rpcaddr 0.0.0.0 --rpcapi admin,db,eth,debug,miner,net,shh,txpool,personal,web3 --rpccorsdomain=* --rpcvhosts=* --emitcheckpoints"
