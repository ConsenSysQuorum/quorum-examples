...
cp perm5.json qdata/dd5/static-nodes.json
cp keys/key5 qdata/dd5/keystore
cp raft/nodekey5 qdata/dd5/geth/nodekey
geth --datadir qdata/dd5 init genesis.json

cp perm5.json qdata/dd1/permissioned-nodes.json
cp perm5.json qdata/dd2/permissioned-nodes.json
cp perm5.json qdata/dd3/permissioned-nodes.json
cp perm5.json qdata/dd4/permissioned-nodes.json
