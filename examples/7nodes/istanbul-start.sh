...
ARGS="--permissioned --nodiscover --istanbul.blockperiod 1 --networkid $NETWORK_ID --syncmode full --mine --minerthreads 1 --rpc --rpcaddr 0.0.0.0 --rpcapi admin,db,eth,debug,miner,net,shh,txpool,personal,web3,quorum,istanbul --istanbul.requesttimeout 10000 --emitcheckpoints --targetgaslimit 18446744073709551615 --syncmode full --nodiscover"
